          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              formData.append(
                ...
                values.schoolOfficialName,
              );
              formData.append(
                "school_official_title",
                values.schoolOfficialTitle,
              );
              formData.append("transcript", values.transcript); // File upload

              // Axios POST request
              axios
                .post("http://localhost:8000/api/scholarship/", formData, {
                  headers: {
            ...
            {({
              ...
              <StyledForm noValidate onSubmit={handleSubmit}>
                  ...
                  <Col md={4}>
                    <Form.Group controlId="formDateOfBirth" className="mb-3">
                      ...
                      <StyledDatePicker
                        ...
                        onChange={(date) => {
                          // Format the date to YYYY-MM-DD before setting the field value
                ...
                <Row>
                  <Col md={3}>
                    <Form.Group
                      controlId="formHighSchoolStudents"
                      className="mb-3"
                    >
                      ...
                      <Input
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.highSchoolStudents &&
                          !!errors.highSchoolStudents
                        }
                      />
                      {touched.highSchoolStudents &&
                        errors.highSchoolStudents && (
                ...
                <Row>
                  <Col md={6}>
                    <Form.Group
                      controlId="formExpectedGraduation"
                      className="mb-3"
                    >
                      ...
                      <StyledDatePicker
                        ...
                        onChange={(date) => {
                          // Format the date to YYYY-MM-DD before setting the field value
                          const formattedDate = format(date, "yyyy-MM-dd");
                          setFieldValue("expectedGraduation", formattedDate);
                        }}
                        onBlur={handleBlur}
                ...
                <Row>
                  <Col md={6}>
                    <Form.Group
                      controlId="formSchoolOfficialName"
                      className="mb-3"
                    >
                      ...
                      <Input
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.schoolOfficialName &&
                          !!errors.schoolOfficialName
                        }
                      />
                      {touched.schoolOfficialName &&
                        errors.schoolOfficialName && (
                  ...
                  <Col md={6}>
                    <Form.Group
                      controlId="formSchoolOfficialTitle"
                      className="mb-3"
                    >
                      ...
                      <Input
                        ...
                        onBlur={handleBlur}
                        isInvalid={
                          touched.schoolOfficialTitle &&
                          !!errors.schoolOfficialTitle
                        }
                      />
                      {touched.schoolOfficialTitle &&
                        errors.schoolOfficialTitle && (
